...
class ApiHistorico {
    ...
    async getDadosHistoricos(parametros) {
        try {
            ...
            console.log('📊 getDadosHistoricos iniciado com:', parametros);
